...
> 来自维基百科 [Java](https://zh.wikipedia.org/wiki/Java)


## 2. 个人理解
其实程序开发解释不断对最开始的01,抽象,总结,再抽象,从最开始打洞编码,到现在已经高度集成化了,从最开始的汇编,其实相当于机器语言的助记符,到C,再到Java这种面向对象高级语言,
